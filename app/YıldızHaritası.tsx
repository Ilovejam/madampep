...
import CustomHeader from '../components/CustomHeader'; // CustomHeader bileşenini ekleyin
import LottieView from 'lottie-react-native';

export default function YıldızHaritası() {
  const allMessages = [
    { id: '1', text: 'Yıldız Haritası Hımm...' },
    { id: '2', text: 'Birileri kaderini Göklerde Arıyor.' },
  ...
  return (
    <ImageBackground source={require('../assets/images/background.png')} style={styles.background}>
      <CustomHeader /> {/* CustomHeader bileşenini ekleyin */}
      <FlatList
        data={messages}
